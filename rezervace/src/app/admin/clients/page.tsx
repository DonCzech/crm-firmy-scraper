  ...
  return (
    <div className="p-6 lg:p-8">
      <div className="mb-6">
        ...
        <p className="text-gray-500 mt-1 text-sm">{clients.length} klientů celkem</p>
      </div>
      ...
      <div className="card overflow-hidden">
        {loading ? (
          ...
          <div className="py-16 text-center">
            ...
            <p className="text-gray-500">Žádní klienti</p>
          </div>
        ) : (
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-gray-100 bg-gray-50">
                  ...
                  <th className="text-left px-6 py-3 text-xs font-medium text-gray-500 uppercase tracking-wider">Rezervace</th>
                  <th className="text-left px-6 py-3 text-xs font-medium text-gray-500 uppercase tracking-wider">Utraceno</th>
                  <th className="text-left px-6 py-3 text-xs font-medium text-gray-500 uppercase tracking-wider">Poslední rezervace</th>
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          {client.client_phone && (
                            <p className="text-xs text-gray-400">{client.client_phone}</p>
                          )}
                        </div>
                      </div>
                    </td>
                    <td className="px-6 py-4">
                      <span className="text-sm font-medium text-gray-900">{client.total_bookings}</span>
                      <span className="text-xs text-gray-400 ml-1">celkem</span>
                    </td>
                    <td className="px-6 py-4">
            ...
            >
              ...
              <div className="overflow-y-auto flex-1 p-6 space-y-3">
                {loadingDetail ? (
                  ...
                  <p className="text-center text-gray-400 py-8">Žádné rezervace</p>
                ) : (
