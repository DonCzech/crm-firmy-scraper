      ...
      <div className="bg-cream rounded-2xl shadow-sm border border-ink-900/10 w-full max-w-md overflow-hidden">
        {done ? (
          <div className="p-10 text-center">
            ...
            <h1 className="text-xl font-bold text-ink-900 mb-2">Rezervace zrušena</h1>
          ...
          <>
            <div className={`px-6 py-5 ${booking.status === 'cancelled' ? 'bg-ink-50' : 'bg-red-50'}`}>
              <h1 className="text-lg font-bold text-ink-900">Zrušení rezervace</h1>
            ...
            <div className="p-6">
              <div className="bg-paper rounded-xl p-4 mb-6 space-y-2 text-sm">
                ...
                <div className="flex justify-between">
                  <span className="text-ink-300">Datum</span>
                ...
                <div className="flex justify-between">
                  <span className="text-ink-300">Čas</span>
                  <span className="text-ink-700">{booking.start_time.substring(0, 5)}</span>
                </div>
              </div>
              ...
              {booking.status === 'cancelled' ? (
                ...
                <>
                  ...
                  <p className="text-xs text-ink-300 text-center mt-3">Tuto akci nelze vrátit zpět.</p>
                </>
              )}
            </div>
          </>
