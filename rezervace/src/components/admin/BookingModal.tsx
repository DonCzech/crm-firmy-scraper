  ...
  return (
    ...
    >
      <motion.div
        ...
        className="bg-cream rounded-2xl shadow-xl w-full max-w-lg overflow-hidden"
      ...
      >
        ...
        <div className="px-6 py-5 border-b border-ink-900/10 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            />
            <h3 className="font-semibold text-ink-900">{booking.service_name}</h3>
        ...
        <div className="p-6">
          ...
          <div className="bg-accent-50 rounded-xl p-4 mb-5">
            <div className="flex items-center gap-2 mb-1">
              ...
              <span className="text-sm font-medium text-accent-800 capitalize">{formattedDate}</span>
            </div>
          ...
          {/* Client details */}
          <h4 className="text-xs font-semibold text-ink-400 uppercase tracking-wider mb-3">Klient</h4>
          <div className="space-y-2.5 mb-5">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <a href={`mailto:${booking.client_email}`} className="text-xs text-accent-600 hover:underline">
            ...
            {booking.client_phone && (
              <div className="flex items-center gap-2 text-sm text-ink-600">
                ...
                <a href={`tel:${booking.client_phone}`} className="hover:text-accent-600">
                  {booking.client_phone}
                </a>
              </div>
            )}
          ...
          {booking.client_notes && (
            <div className="mb-5">
              <h4 className="text-xs font-semibold text-ink-400 uppercase tracking-wider mb-2">Poznámky</h4>
              <p className="text-sm text-ink-700 bg-paper rounded-lg p-3">{booking.client_notes}</p>
            </div>
          )}

          {/* Price */}
          <div className="flex items-center justify-between text-sm mb-6">
            <span className="text-ink-400">Cena</span>
