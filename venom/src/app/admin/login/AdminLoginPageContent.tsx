...
export function LoginForm({ locale = "cs" }: { locale?: PlatformLocale } = {}) {
    ...
    <div className="relative min-h-screen overflow-hidden bg-[#080810] flex items-center justify-center px-4">
      ...
      >
        ...
        <p className="mt-8 text-center text-[12px] text-white/30">
          <Link href={locale === "en" ? "/en" : "/"} className="text-indigo-400/80 transition hover:text-indigo-300">
            {copy.back}
          </Link>
        </p>
      </div>
...
export function AdminLoginPageContent({ locale = "cs" }: { locale?: PlatformLocale } = {}) {
  return (
    <Suspense>
...
export default function AdminLoginPage() {
  return <AdminLoginPageContent locale="cs" />;
}
