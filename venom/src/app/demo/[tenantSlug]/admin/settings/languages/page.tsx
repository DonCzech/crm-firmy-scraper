...
import { LanguagesSettings } from "@/components/admin/settings/LanguagesSettings";
...
export default async function SettingsLanguagesPage({ params }: Props) {
  ...
  return <LanguagesSettings tenantSlug={tenantSlug} />;
}
