...
import { EmailsSettings } from "@/components/admin/settings/EmailsSettings";
...
export default async function SettingsEmailsPage({ params }: Props) {
  ...
  return <EmailsSettings tenant={tenant} />;
}
