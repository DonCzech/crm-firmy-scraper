...
import { CookieSettings } from "@/components/admin/settings/CookieSettings";
...
export default async function SettingsCookiesPage({ params }: Props) {
  ...
  return <CookieSettings tenant={tenant} />;
}
