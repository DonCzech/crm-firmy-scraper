  ...
  return (
    <button
      ...
      className={clsx(
        ...
        active
          ? "bg-[rgba(var(--vs-cta-rgb),0.18)] text-[var(--vs-cta-text-hi)] shadow-[inset_0_0_0_1px_rgba(var(--vs-cta-soft-rgb),0.34),0_0_18px_rgba(var(--vs-cta-rgb),0.18)]"
          : "bg-[var(--vs-cta-grad)] text-white shadow-[0_1px_0_rgba(255,255,255,0.22)_inset,0_8px_22px_rgba(var(--vs-cta-rgb),0.34)] hover:shadow-[0_1px_0_rgba(255,255,255,0.25)_inset,0_10px_28px_rgba(var(--vs-cta-rgb),0.46)]",
      )}
    >
