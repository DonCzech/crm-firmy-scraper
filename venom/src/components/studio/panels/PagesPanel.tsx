      ...
      <div className="flex flex-1 flex-col bg-white">
        ...
        <div className="flex h-[52px] shrink-0 items-center justify-between px-5 border-b border-gray-200 bg-white">
          ...
          <button
            ...
            onClick={handleSave}
            disabled={busy}
            className="rounded-md bg-[#2563eb] px-5 py-1.5 text-[12.5px] font-semibold text-white hover:bg-[#1d4ed8] disabled:opacity-60"
          >
            {busy ? "Ukládám…" : "Uložit"}
          </button>
        </div>
...
const inputCls =
  "w-full rounded-lg border border-gray-300 px-3.5 py-2.5 text-[14px] text-gray-800 placeholder-gray-400 focus:border-[#2563eb] focus:ring-2 focus:ring-[#2563eb]/15 focus:outline-none transition-shadow";
              ...
              {creating && (
                <form onSubmit={createPage} className="mx-3 my-2 rounded-lg border border-[var(--vs-border-strong)] bg-[var(--vs-surface)] p-3">
                  <input
                    ...
                    autoFocus
                    className="mb-2 h-8 w-full rounded-md border border-[var(--vs-border)] bg-[var(--vs-bg-soft)] px-2.5 text-[13px] text-[var(--vs-text)] placeholder-[var(--vs-text-dim)] focus:border-[#3b82f6] focus:outline-none"
                  />
                  <input
                    type="text"
                    value={newSlug}
                    ...
                    className="mb-2.5 h-8 w-full rounded-md border border-[var(--vs-border)] bg-[var(--vs-bg-soft)] px-2.5 text-[13px] text-[var(--vs-text)] placeholder-[var(--vs-text-dim)] focus:border-[#3b82f6] focus:outline-none"
                  />
                  <div className="flex justify-end gap-2">
                    ...
                    <button type="submit" disabled={busy || !newTitle} className="rounded-md bg-[#2563eb] px-3 py-1.5 text-[12px] font-semibold text-white hover:bg-[#1d4ed8] disabled:opacity-50">{busy ? "Vytvářím…" : "Vytvořit"}</button>
                  </div>
                </form>
              )}
            </NavSection>
