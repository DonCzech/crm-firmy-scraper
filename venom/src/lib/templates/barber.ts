...
const SITE_NAME = "Blade & Co. Barbershop";
const ACCENT = "#C9A84C";
const PHONE = "+420 602 456 789";
const EMAIL = "info@bladeandco.cz";
...
const footerContent = {
  ...
  email: EMAIL,
  address: ADDRESS,
  copyright: `© ${new Date().getFullYear()} Blade & Co. Barbershop. Všechna práva vyhrazena.`,
};
...
export const barberTemplate: TemplateDefinition = {
  ...
  pages: [
    {
      slug: "o-nas",
      title: "O nás",
      seoTitle: "O barbershopu | Blade & Co. Barbershop Brno",
      seoDescription: "Poznejte tým a příběh Blade & Co. Barbershopu v Brně.",
      sections: [
        ...
        { type: "about", variant: "two-col", order: 2, visible: true, content: {
          ...
          body: "Blade & Co. vzniklo v roce 2018 s jednoduchou myšlenkou — vrátit holení a střihy do rukou opravdových mistrů. Náš tým absolvoval výcviky v Londýně a Amsterdamu. Každá návštěva je pro nás příležitostí ukázat, co znamená skutečná péče o muže.",
        ...
        { type: "team",   variant: "cards-grid", order: 3, visible: true, content: {
          ...
          members: [
            { name: "Lukáš Horák",  role: "Head Barber & Majitel",   bio: "12 let za nůžkami, certifikát London Barber Academy.", image: "" },
            { name: "Ondřej Blaha", role: "Senior Barber",            bio: "Specialista na fade střihy a kreativní linky, 7 let praxe.", image: "" },
            { name: "Radek Tůma",   role: "Barber & Grooming Expert", bio: "Milovník klasického holení a precizní péče o vousy.", image: "" },
          ],
        }},
    ...
    },
    {
      slug: "sluzby",
      title: "Služby",
      seoTitle: "Ceník a služby | Blade & Co. Barbershop Brno",
    ...
    },
    {
      slug: "galerie",
      title: "Galerie",
      seoTitle: "Galerie | Blade & Co. Barbershop Brno",
      ...
      sections: [
        ...
        { type: "gallery", variant: "masonry",      order: 2, visible: true, content: {
          ...
          images: [
            ...
            { url: "/images/template-gallery/barber-02-salon-chair-thumb-331x331.webp",   fullUrl: "/images/template-gallery/barber-02-salon-chair-full-1920x1080.webp",   alt: "Blade & Co. ve svém živlu" },
            ...
            { url: "/images/template-gallery/barber-05-barber-lights-thumb-331x331.webp", fullUrl: "/images/template-gallery/barber-05-barber-lights-full-1920x1080.webp", alt: "Atmosféra studia" },
    ...
    },
    {
      slug: "kontakt",
      title: "Kontakt",
      seoTitle: "Kontakt a rezervace | Blade & Co. Barbershop Brno",
  ...
  demoContent: {
    siteName: SITE_NAME,
    tagline: "Autentická péče pro moderního muže",
    description: "Blade & Co. Barbershop v srdci Brna. Fade střihy, holení britvou, úprava vousů.",
    ...
    testimonials: {
      ...
      testimonials: [
        ...
        { name: "Petr O.",   text: "Blade & Co. je nejlepší barbershop v Brně. Přátelský tým, skvělé výsledky pokaždé.", rating: 5 },
      ],
    },
    ...
    seo: {
      title: "Blade & Co. Barbershop Brno | Fade střihy a holení britvou",
      description: "Blade & Co. Barbershop v Brně. Fade střihy, holení britvou, úprava vousů. Rezervujte online.",
      localBusiness: {
        type: "HairSalon",
        name: SITE_NAME,
        phone: PHONE,
