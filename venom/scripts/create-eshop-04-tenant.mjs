/**
 * Create tenant eshop-04-v2 for the eshop-04 (Shoptet Samba) template.
 * - tenant (tenant_kind commerce) + shop + core commerce modules
 * - pages + sections from src/templates/eshop-04/template.json (legacy settings)
 * Idempotent: reuses existing tenant, re-seeds pages/sections from manifest.
 * Usage: node scripts/create-eshop-04-tenant.mjs
 */
import pg from "pg";
...
const TEMPLATE_KEY = "eshop-04";
const TENANT_SLUG = "eshop-04-v2";
const SHOP_NAME = "Pastelka";
