/**
 * Create tenant eshop-12-v2 for the eshop-12 (petcenter DNA) template.
 * Idempotent: reuses existing tenant, re-seeds pages/sections from manifest.
 * Usage: node scripts/create-eshop-12-tenant.mjs
 */
import pg from "pg";
...
const TEMPLATE_KEY = "eshop-12";
const TENANT_SLUG = "eshop-12-v2";
const SHOP_NAME = "PACKA";
...
try {
  ...
  for (const page of manifest.pages) {
    ...
    // Podstránky = legacy: jejich varianty (eshop-12-contact, -text, …) nejsou
