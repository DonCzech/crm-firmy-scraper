/**
 * Create tenant eshop-18-v2 for the eshop-18 (Auto Kelly DNA — Oktan autodíly) template.
 * Idempotent: reuses existing tenant, re-seeds pages/sections from manifest.
 * Usage: node scripts/create-eshop-18-tenant.mjs
 */
import pg from "pg";
...
const TEMPLATE_KEY = "eshop-18";
const TENANT_SLUG = "eshop-18-v2";
const SHOP_NAME = "Oktan";
...
try {
  ...
  for (const page of manifest.pages) {
    ...
    // Podstránky = legacy: jejich varianty (eshop-18-contact, -text, …) nejsou
