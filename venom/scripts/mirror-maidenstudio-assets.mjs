/**
 * Mirror maidenstudio.cz — Wix Thunderbolt SPA
 */
...
const ORIGIN = 'https://www.maidenstudio.cz';
...
function processHtml(html) {
  ...
  html = html.replaceAll('https://www.maidenstudio.cz', '');
  return html;
}
...
for (const p of PAGES) {
  ...
  const brandLeft = (processed.match(/maidenstudio\.cz/gi) || []).length;
