#!/usr/bin/env node
/**
 * Seed klima-01 master tenant (slug: klima-01-demo).
 * Template: klima-01 — Demo PragoClima (navy #182545, červená #e30016, Outfit)
 */
import pg from 'pg';
...
const SLUG = 'klima-01-demo';
const EMAIL = 'demo@klima-01.test';
const TEMPLATE_KEY = 'klima-01';
const INDUSTRY = 'klima';
