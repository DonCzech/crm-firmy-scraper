#!/usr/bin/env node
// Přímé seedování nails-01 tenant do DB (bez onboarding API)
import pg from 'pg';
...
const SLUG = 'nails-01-demo';
const EMAIL = 'demo@nails-01.test';
const TEMPLATE_KEY = 'nails-01';
const INDUSTRY = 'nails';
...
try {
  ...
  console.log(`✓ cleanup: removed ${del.rowCount} old tenants`);
  ...
  const siteName = rawContent.navbar?.siteName ?? 'Demo Soho Nails & Spa';
  ...
  console.log(`\n✅ nails-01-demo seeded`);
  console.log(`   preview: http://localhost:3015/demo/${SLUG}`);
  console.log(`   studio:  http://localhost:3015/demo/${SLUG}/studio`);
