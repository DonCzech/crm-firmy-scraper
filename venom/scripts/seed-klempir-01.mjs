#!/usr/bin/env node
/**
 * Seed klempir-01 master tenant (slug: klempir-01-demo).
 * Template: klempir-01 — Demo Klempíř z Prahy (stříbrná #c0c0c0, tmavá #3a3a3a, Montserrat)
 */
import pg from 'pg';
...
const SLUG = 'klempir-01-demo';
const EMAIL = 'demo@klempir-01.test';
const TEMPLATE_KEY = 'klempir-01';
const INDUSTRY = 'klempir';
...
async function main() {
  ...
  const res = await fetch(`${baseUrl}/api/onboarding`, {
    ...
    body: JSON.stringify({
      businessName: 'Demo Klempíř z Prahy',
      email: EMAIL,
