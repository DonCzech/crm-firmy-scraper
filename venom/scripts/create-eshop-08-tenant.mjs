/**
 * Create tenant eshop-08-v2 for the eshop-08 (Oveckarna.cz DNA) template.
 * Idempotent: reuses existing tenant, re-seeds pages/sections from manifest.
 * Usage: node scripts/create-eshop-08-tenant.mjs
 */
import pg from "pg";
...
const TEMPLATE_KEY = "eshop-08";
const TENANT_SLUG = "eshop-08-v2";
const SHOP_NAME = "Domea";
...
try {
  ...
  for (const page of manifest.pages) {
    ...
    // Podstránky = legacy: jejich varianty (eshop-08-contact, -text, …) nejsou
