...
const SLUG = 'fyzio-02-v2';
const EMAIL = 'demo@fyzio-02.test';
const TEMPLATE_KEY = 'fyzio-02';
const INDUSTRY = 'fyzio';
...
async function main() {
  ...
  const res = await fetch(`${baseUrl}/api/onboarding`, {
    method: 'POST',
    headers: { 'Content-Type': 'application/json', Origin: baseUrl, Referer: baseUrl + '/', 'X-Forwarded-For': '10.88.22.2' },
    body: JSON.stringify({
      businessName: 'Demo Reset Fyzio',
      email: EMAIL,
