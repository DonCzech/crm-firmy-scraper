#!/usr/bin/env node
/**
 * Direct DB seed for hotel-01 — bypasses /api/onboarding
 * Replicates loader.ts + tenant-factory.ts logic in plain JS.
 */
import pg from 'pg';
...
const SLUG         = 'hotel-01-demo';
const EMAIL        = 'demo@hotel-01.test';
const TEMPLATE_KEY = 'hotel-01';
