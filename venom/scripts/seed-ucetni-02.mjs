#!/usr/bin/env node
/**
 * Seed ucetni-02 master tenant (slug: ucetni-02-v2).
 * Template: ucetni-02 — Demo Daňový Poradce (zelená #004835 primary, zlatá #bca160 akcent)
 */
import pg from 'pg';
...
const SLUG = 'ucetni-02-v2';
const EMAIL = 'demo@ucetni-02.test';
const TEMPLATE_KEY = 'ucetni-02';
...
async function main() {
  ...
  const res = await fetch(`${baseUrl}/api/onboarding`, {
    ...
    body: JSON.stringify({
      businessName: 'Demo Daňový Poradce',
      email: EMAIL,
