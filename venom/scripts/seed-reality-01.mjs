#!/usr/bin/env node
/**
 * Seed reality-01 master tenant (fixed slug: reality-01-v2).
 * - Removes previous reality-01-v2 tenant
 * - POSTs onboarding with templateKey=reality-01
 */
import pg from 'pg';
...
const SLUG = 'reality-01-v2';
const EMAIL = 'demo@reality-01.test';
const TEMPLATE_KEY = 'reality-01';
const INDUSTRY = 'reality';
...
async function main() {
  ...
  const res = await fetch(`${baseUrl}/api/onboarding`, {
    ...
    headers: {
      ...
      Origin: baseUrl,
      Referer: baseUrl + '/',
      'X-Forwarded-For': '10.88.33.2',
    },
    body: JSON.stringify({
      businessName: 'Demo Norton Realty',
      email: EMAIL,
