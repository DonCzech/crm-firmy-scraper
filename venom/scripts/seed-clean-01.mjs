#!/usr/bin/env node
/**
 * Seed clean-01 master tenant (slug: clean-01-demo).
 * Template: clean-01 — Demo Clean (zelená #69be28, tmavý navbar #0d1a20)
 */
import pg from 'pg';
...
const SLUG = 'clean-01-demo';
const EMAIL = 'demo@clean-01.test';
const TEMPLATE_KEY = 'clean-01';
