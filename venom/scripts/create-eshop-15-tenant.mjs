/**
 * Create tenant eshop-15-v2 for the eshop-15 (pilulka DNA) template.
 * Idempotent: reuses existing tenant, re-seeds pages/sections from manifest.
 * Usage: node scripts/create-eshop-15-tenant.mjs
 */
import pg from "pg";
...
const TEMPLATE_KEY = "eshop-15";
const TENANT_SLUG = "eshop-15-v2";
const SHOP_NAME = "Apatyka";
...
try {
  ...
  for (const page of manifest.pages) {
    ...
    // Podstránky = legacy: jejich varianty (eshop-15-contact, -text, …) nejsou
