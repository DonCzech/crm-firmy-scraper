/**
 * FÁZE 1 — mirror schlieger.cz (WordPress + Elementor, fotovoltaika)
 */
...
const ORIGIN = 'https://schlieger.cz';
...
console.log('Navigating schlieger.cz...');
...
await page.screenshot({ path: '/tmp/schlieger-orig-full.jpg', fullPage: true });
