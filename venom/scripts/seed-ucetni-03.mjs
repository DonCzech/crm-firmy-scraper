#!/usr/bin/env node
/**
 * Seed ucetni-03 master tenant (slug: ucetni-03-v2).
 * Template: ucetni-03 — Demo Hypoteční Poradce (tmavě zelená #002000 primary, zelená #4caf50 akcent)
 */
import pg from 'pg';
...
const SLUG = 'ucetni-03-v2';
const EMAIL = 'demo@ucetni-03.test';
const TEMPLATE_KEY = 'ucetni-03';
...
async function main() {
  ...
  const res = await fetch(`${baseUrl}/api/onboarding`, {
    ...
    body: JSON.stringify({
      businessName: 'Demo Hypoteční Poradce',
      email: EMAIL,
