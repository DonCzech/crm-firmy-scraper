#!/usr/bin/env node
/**
 * Direct DB seed for photo-01 — bypasses /api/onboarding
 * photo-01 — Demo Fotografka (cream #f5f0eb, brown #8b7355, Georgia serif)
 */
import pg from 'pg';
...
const SLUG         = 'photo-01-demo';
const EMAIL        = 'demo@photo-01.test';
const TEMPLATE_KEY = 'photo-01';
const INDUSTRY     = 'photo';
