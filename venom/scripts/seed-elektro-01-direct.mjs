#!/usr/bin/env node
/**
 * Direct DB seed for elektro-01 — bypasses the /api/onboarding route
...
const SLUG         = 'elektro-01-v2';
const EMAIL        = 'demo@elektro-01.test';
const TEMPLATE_KEY = 'elektro-01';
const INDUSTRY     = 'elektro';
  ...
  try {
    ...
    const pageRes = await client.query(
      `INSERT INTO pages (tenant_id, slug, title, is_homepage, status)
       ...
       RETURNING id`,
      [tenantId, tpl.demoContent.siteName ?? 'Demo Elektro']
    );
