#!/usr/bin/env node
/**
 * Seed hotel-01 master tenant (slug: hotel-01-demo).
 * Template: hotel-01 — Demo Boutique Hotel (gold #a98763, green #879B32, Playfair Display)
 */
import pg from 'pg';
...
async function main() {
  ...
  const res = await fetch(`${baseUrl}/api/onboarding`, {
    ...
    body: JSON.stringify({
      businessName: 'Demo Boutique Hotel',
      email: EMAIL,
