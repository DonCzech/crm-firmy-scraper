#!/usr/bin/env node
/**
 * Seed video-01 master tenant (slug: video-01-demo).
 * Template: video-01 — Demo Kameraman (bílý #fff, zlatý #C49A6C, tmavý #2E2A28, Playfair+Inter)
 */
import pg from 'pg';
