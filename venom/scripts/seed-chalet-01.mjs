#!/usr/bin/env node
/**
 * Seed chalet-01 master tenant (slug: chalet-01-demo).
 * Template: chalet-01 — Demo Horský Chalet (béžová #c0bbad, tmavá #1e2329, Josefin Sans)
 */
import pg from 'pg';
...
const SLUG = 'chalet-01-demo';
const EMAIL = 'demo@chalet-01.test';
const TEMPLATE_KEY = 'chalet-01';
const INDUSTRY = 'chalet';
...
async function main() {
  ...
  const res = await fetch(`${baseUrl}/api/onboarding`, {
    ...
    body: JSON.stringify({
      businessName: 'Demo Horský Chalet',
      email: EMAIL,
