#!/usr/bin/env node
/**
 * Seed malir-02 master tenant (slug: malir-02-demo).
 * Template: malir-02 — Malířství Novák (oranžový #ff914d, tmavý #232323, Poppins + Roboto)
 */
import pg from 'pg';
...
const SLUG = 'malir-02-demo';
const EMAIL = 'demo@malir-02.test';
const TEMPLATE_KEY = 'malir-02';
