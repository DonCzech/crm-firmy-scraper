#!/usr/bin/env node
/**
 * Seed kids-01 master tenant (slug: kids-01-v2).
 * Template: kids-01 — Demo Kroužky (modrý #009BDE primary, žlutý #ffc107 akcent)
 */
import pg from 'pg';
...
const SLUG = 'kids-01-v2';
const EMAIL = 'demo@kids-01.test';
const TEMPLATE_KEY = 'kids-01';
const INDUSTRY = 'kids';
