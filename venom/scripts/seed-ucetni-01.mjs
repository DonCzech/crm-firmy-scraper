#!/usr/bin/env node
/**
 * Seed ucetni-01 master tenant (slug: ucetni-01-v2).
 * Template: ucetni-01 — Demo Účetnictví (zlatá #FFB500 primary)
 */
import pg from 'pg';
...
const SLUG = 'ucetni-01-v2';
const EMAIL = 'demo@ucetni-01.test';
const TEMPLATE_KEY = 'ucetni-01';
