#!/usr/bin/env node
/**
 * Seed arbo-01 master tenant (slug: arbo-01-demo).
 * Template: arbo-01 — Demo Lesarb (zelená #106133, béžová #e0cebc, Fira Sans)
 */
import pg from 'pg';
...
const SLUG = 'arbo-01-demo';
const EMAIL = 'demo@arbo-01.test';
const TEMPLATE_KEY = 'arbo-01';
const INDUSTRY = 'arbo';
