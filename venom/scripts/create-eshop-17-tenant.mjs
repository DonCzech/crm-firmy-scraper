/**
 * Create tenant eshop-17-v2 for the eshop-17 (florea DNA) template.
 * Idempotent: reuses existing tenant, re-seeds pages/sections from manifest.
 * Usage: node scripts/create-eshop-17-tenant.mjs
 */
import pg from "pg";
...
const TEMPLATE_KEY = "eshop-17";
const TENANT_SLUG = "eshop-17-v2";
const SHOP_NAME = "Rozkvět";
...
try {
  ...
  for (const page of manifest.pages) {
    ...
    // Podstránky = legacy: jejich varianty (eshop-17-contact, -text, …) nejsou
