#!/usr/bin/env node
// Přímé seedování tattoo-02 tenant do DB (bez onboarding API)
import pg from 'pg';
...
const SLUG = 'tattoo-02-demo';
const EMAIL = 'demo@tattoo-02.test';
const TEMPLATE_KEY = 'tattoo-02';
...
try {
  ...
  const siteName = rawContent.navbar?.siteName ?? 'Demo Homie Tattoo';
