#!/usr/bin/env node
/**
 * Seed clean-02 master tenant (slug: clean-02-demo).
 * Template: clean-02 — Demo Modrý Žralok (modrá #1c91ff, navy #0e0e53)
 */
import pg from 'pg';
...
const SLUG = 'clean-02-demo';
const EMAIL = 'demo@clean-02.test';
const TEMPLATE_KEY = 'clean-02';
...
async function main() {
  ...
  const res = await fetch(`${baseUrl}/api/onboarding`, {
    ...
    body: JSON.stringify({
      businessName: 'Demo Modrý Žralok',
      email: EMAIL,
