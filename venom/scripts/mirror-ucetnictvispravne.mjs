/**
 * FÁZE 1 — mirror ucetnictvispravne.cz (WordPress, účetní firma)
 */
...
const ORIGIN = 'https://www.ucetnictvispravne.cz';
...
console.log('Navigating ucetnictvispravne.cz...');
...
await page.screenshot({ path: '/tmp/ucetnictvispravne-orig-full.jpg', fullPage: true });
...
console.log(`Complianz=${lower.includes('complianz')} Elementor=${lower.includes('elementor')}`);
