#!/usr/bin/env node
/**
 * Seed garden-02 master tenant (slug: garden-02-demo).
 * Template: garden-02 — Demo PolGarden (zelená #95c11f, tmavá #1a2a0a)
 */
import pg from 'pg';
...
const SLUG = 'garden-02-demo';
const EMAIL = 'demo@garden-02.test';
const TEMPLATE_KEY = 'garden-02';
const INDUSTRY = 'garden';
