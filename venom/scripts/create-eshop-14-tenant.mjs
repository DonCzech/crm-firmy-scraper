/**
 * Create tenant eshop-14-v2 for the eshop-14 (mountfield DNA) template.
 * Idempotent: reuses existing tenant, re-seeds pages/sections from manifest.
 * Usage: node scripts/create-eshop-14-tenant.mjs
 */
import pg from "pg";
...
const TEMPLATE_KEY = "eshop-14";
const TENANT_SLUG = "eshop-14-v2";
const SHOP_NAME = "Zahradia";
...
try {
  ...
  for (const page of manifest.pages) {
    ...
    // Podstránky = legacy: jejich varianty (eshop-14-contact, -text, …) nejsou
