/**
 * Create tenant eshop-11-v2 for the eshop-11 (hanibal DNA) template.
 * Idempotent: reuses existing tenant, re-seeds pages/sections from manifest.
 * Usage: node scripts/create-eshop-11-tenant.mjs
 */
import pg from "pg";
...
const TEMPLATE_KEY = "eshop-11";
const TENANT_SLUG = "eshop-11-v2";
const SHOP_NAME = "HORAL";
...
try {
  ...
  for (const page of manifest.pages) {
    ...
    // Podstránky = legacy: jejich varianty (eshop-11-contact, -text, …) nejsou
