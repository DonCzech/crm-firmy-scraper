/**
 * Create tenant eshop-19-v2 for the eshop-19 (dek.cz DNA — Grunt stavebniny) template.
 * Idempotent: reuses existing tenant, re-seeds pages/sections from manifest.
 * Usage: node scripts/create-eshop-19-tenant.mjs
 */
import pg from "pg";
...
const TEMPLATE_KEY = "eshop-19";
const TENANT_SLUG = "eshop-19-v2";
const SHOP_NAME = "Grunt";
...
try {
  ...
  for (const page of manifest.pages) {
    ...
    // Podstránky = legacy: jejich varianty (eshop-19-contact, -text, …) nejsou
