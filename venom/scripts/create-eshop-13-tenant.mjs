/**
 * Create tenant eshop-13-v2 for the eshop-13 (milagro DNA) template.
 * Idempotent: reuses existing tenant, re-seeds pages/sections from manifest.
 * Usage: node scripts/create-eshop-13-tenant.mjs
 */
import pg from "pg";
...
const TEMPLATE_KEY = "eshop-13";
const TENANT_SLUG = "eshop-13-v2";
const SHOP_NAME = "LUNELA";
...
try {
  ...
  for (const page of manifest.pages) {
    ...
    // Podstránky = legacy: jejich varianty (eshop-13-contact, -text, …) nejsou
