#!/usr/bin/env node
/**
 * Seed edu-01 master tenant (slug: edu-01-v2).
 * Template: edu-01 — Demo Akademie (navy #132339 + modrý #0059df akcent, Libre Franklin)
 */
import pg from 'pg';
...
const SLUG = 'edu-01-v2';
const EMAIL = 'demo@edu-01.test';
const TEMPLATE_KEY = 'edu-01';
const INDUSTRY = 'edu';
