#!/usr/bin/env node
/**
 * Seed malir-01 master tenant (slug: malir-01-demo).
 * Template: malir-01 — Demo Petrovo malování (amber #E79B0E, černý #000000, Playfair Display + Raleway)
 */
import pg from 'pg';
...
const SLUG = 'malir-01-demo';
const EMAIL = 'demo@malir-01.test';
const TEMPLATE_KEY = 'malir-01';
const INDUSTRY = 'malir';
...
async function main() {
  ...
  const res = await fetch(`${baseUrl}/api/onboarding`, {
    ...
    body: JSON.stringify({
      businessName: 'Demo Petrovo malování',
      email: EMAIL,
