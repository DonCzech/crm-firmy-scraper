/**
 * Create tenant eshop-03-v2 for the eshop-03 (Shoptet Disco) template.
 * - tenant (tenant_kind commerce) + shop + core commerce modules
 * - pages + sections from src/templates/eshop-03/template.json (legacy settings)
 * Idempotent: reuses existing tenant, re-seeds pages/sections from manifest.
 * Usage: node scripts/create-eshop-03-tenant.mjs
 */
import pg from "pg";
...
const TEMPLATE_KEY = "eshop-03";
const TENANT_SLUG = "eshop-03-v2";
const SHOP_NAME = "Pohodář";
