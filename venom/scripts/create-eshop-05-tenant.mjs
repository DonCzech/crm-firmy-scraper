/**
 * Create tenant eshop-05-v2 for the eshop-05 (Pompo.cz DNA) template.
 * Idempotent: reuses existing tenant, re-seeds pages/sections from manifest.
 * Usage: node scripts/create-eshop-05-tenant.mjs
 */
import pg from "pg";
...
const TEMPLATE_KEY = "eshop-05";
const TENANT_SLUG = "eshop-05-v2";
const SHOP_NAME = "Hračkolandia";
