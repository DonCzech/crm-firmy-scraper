/**
 * FÁZE 1 — mirror brokerconsulting.cz → redirects to bcas.cz (finanční poradce)
 */
...
console.log('Navigating bcas.cz...');
...
await page.screenshot({ path: '/tmp/brokerconsulting-orig-full.jpg', fullPage: true });
