...
const SLUG = 'lawyer-01-v2';
const EMAIL = 'demo@lawyer-01.test';
const TEMPLATE_KEY = 'lawyer-01';
const INDUSTRY = 'lawyer';
...
async function main() {
  ...
  const res = await fetch(`${baseUrl}/api/onboarding`, {
    method: 'POST',
    headers: { 'Content-Type': 'application/json', Origin: baseUrl, Referer: baseUrl + '/', 'X-Forwarded-For': '10.88.33.1' },
    body: JSON.stringify({
      businessName: 'Demo HAVEL & PARTNERS',
      email: EMAIL,
