/**
 * FÁZE 1 — mirror cutedogs.cz (WordPress, psí salon)
 */
...
const SLUG   = 'cutedogs';
const ORIGIN = 'https://www.cutedogs.cz';
...
console.log('Navigating cutedogs.cz...');
...
await page.screenshot({ path: '/tmp/cutedogs-orig-full.jpg', fullPage: true });
