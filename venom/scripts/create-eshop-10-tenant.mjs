/**
 * Create tenant eshop-10-v2 for the eshop-10 (footshop DNA) template.
 * Idempotent: reuses existing tenant, re-seeds pages/sections from manifest.
 * Usage: node scripts/create-eshop-10-tenant.mjs
 */
import pg from "pg";
...
const TEMPLATE_KEY = "eshop-10";
const TENANT_SLUG = "eshop-10-v2";
const SHOP_NAME = "BOTIQ";
...
try {
  ...
  for (const page of manifest.pages) {
    ...
    // Podstránky = legacy: jejich varianty (eshop-10-contact, -text, …) nejsou
