/**
 * Create tenant eshop-16-v2 for the eshop-16 (kosik DNA) template.
 * Idempotent: reuses existing tenant, re-seeds pages/sections from manifest.
 * Usage: node scripts/create-eshop-16-tenant.mjs
 */
import pg from "pg";
...
const TEMPLATE_KEY = "eshop-16";
const TENANT_SLUG = "eshop-16-v2";
const SHOP_NAME = "Spížka";
...
try {
  ...
  for (const page of manifest.pages) {
    ...
    // Podstránky = legacy: jejich varianty (eshop-16-contact, -text, …) nejsou
