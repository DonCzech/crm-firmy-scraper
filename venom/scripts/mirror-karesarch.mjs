/**
 * FÁZE 1 — mirror karesarch.cz (TYPO3 CMS, architektonický ateliér Kareš)
 */
...
console.log('Navigating karesarch.cz...');
...
await page.screenshot({ path: '/tmp/karesarch-orig-full.jpg', fullPage: true });
