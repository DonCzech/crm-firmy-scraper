#!/usr/bin/env node
/**
 * Seed ddd-01 master tenant (slug: ddd-01-demo).
 * Template: ddd-01 — Demo Deratizace (modrá #0c93eb, navy #064e86, Figtree)
 */
import pg from 'pg';
...
const SLUG = 'ddd-01-demo';
const EMAIL = 'demo@ddd-01.test';
const TEMPLATE_KEY = 'ddd-01';
const INDUSTRY = 'ddd';
