/**
 * Mirror deratizacepraha.com — custom Vue/SPA site
 */
...
const BASE_URL = 'https://www.deratizacepraha.com';
const CLONE_DIR = '/Users/apple/DEV/CRM/venom/public/clones/deratizace';
...
const PAGES = [
  ...
  { slug: 'deratizace', url: '/deratizace-hubeni-hlodavcu' },
...
context.on('response', async (response) => {
  ...
  if (!url.includes('deratizacepraha.com')) return;
  ...
  assetMap[url.split('?')[0]] = `/clones/deratizace${urlPath}`;
