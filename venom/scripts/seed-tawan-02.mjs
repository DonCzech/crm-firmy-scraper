...
const SLUG = 'tawan-02-demo';
const EMAIL = 'demo@tawan-02.test';
const TEMPLATE_KEY = 'tawan-02';
const INDUSTRY = 'wellness';
...
async function main() {
  ...
  const res = await fetch(`${baseUrl}/api/onboarding`, {
    ...
    body: JSON.stringify({
      businessName: 'Demo Escape Massage',
      email: EMAIL,
  ...
  console.log(`✓ tawan-02 tenant created`);
