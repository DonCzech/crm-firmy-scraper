#!/usr/bin/env node
/**
 * Seed vet-01 master tenant (slug: vet-01-v2).
 * Template: vet-01 — Demo Veterinární Klinika (teal #0d7486 primary)
 */
import pg from 'pg';
...
const SLUG = 'vet-01-v2';
const EMAIL = 'demo@vet-01.test';
const TEMPLATE_KEY = 'vet-01';
const INDUSTRY = 'vet';
...
async function main() {
  ...
  const res = await fetch(`${baseUrl}/api/onboarding`, {
    ...
    body: JSON.stringify({
      businessName: 'Demo Veterinární Klinika',
      email: EMAIL,
