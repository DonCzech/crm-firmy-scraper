/**
 * FÁZE 1 — mirror tkreko.cz (WordPress + Elementor, fotovoltaika)
 */
...
const SLUG   = 'tkreko';
const ORIGIN = 'https://www.tkreko.cz';
...
console.log('Navigating tkreko.cz...');
...
await page.screenshot({ path: '/tmp/tkreko-orig-full.jpg', fullPage: true });
