#!/usr/bin/env node
/**
 * Seed instala-02 master tenant (slug: instala-02-demo).
 * Template: instala-02 — Demo Vestop (červená #ee4036, Montserrat+Roboto)
 */
import pg from 'pg';
...
const SLUG = 'instala-02-demo';
const EMAIL = 'demo@instala-02.test';
const TEMPLATE_KEY = 'instala-02';
