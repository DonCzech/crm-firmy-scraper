/**
 * FÁZE 1 — mirror grantex.cz (daňový poradce)
 */
...
console.log('Navigating grantex.cz...');
...
await page.screenshot({ path: '/tmp/grantex-orig-full.jpg', fullPage: true });
...
console.log(`Complianz=${lower.includes('complianz')} Elementor=${lower.includes('elementor')} WpJson=${lower.includes('wp-json')}`);
