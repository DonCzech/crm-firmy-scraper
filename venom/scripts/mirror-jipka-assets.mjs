/**
 * Mirror jipka.cz — Jazyková škola (WordPress mango-jipka theme)
 */
...
const SLUG   = 'jipka';
const ORIGIN = 'https://www.jipka.cz';
...
console.log('Navigating jipka.cz...');
await page.goto(ORIGIN, { waitUntil: 'domcontentloaded', timeout: 30000 });
await page.waitForTimeout(3000);

// Dismiss cookie
try {
  await page.click('button:has-text("Souhlasím"), button:has-text("Přijmout"), button:has-text("Přijmout vše"), button:has-text("Souhlasit s vším"), .cookie-accept, .cmplz-accept, #cn-accept-cookie', { timeout: 3000 });
...
console.log(`CMS: WP=${rawLower.includes('wp-content')} Wix=${rawLower.includes('parastorage')}`);
console.log('=== HOTOVO ===');
