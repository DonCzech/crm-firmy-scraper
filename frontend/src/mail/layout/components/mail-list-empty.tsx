        ...
        <ScrollArea className="h-[calc(100vh-7rem)] grid content-center">
          <div className="flex flex-col items-center justify-center">
            ...
            <div className="text-center">
              ...
              <p className="text-muted-foreground text-2sm">Search for another email or <Link to="/core/dashboard" className="hover:text-primary text-muted-foreground underline">clear filters</Link></p>
            </div> 
          </div>           
        </ScrollArea>
      </div>
