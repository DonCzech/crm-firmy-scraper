...
interface LayoutState {
  ...
  activeCalendarView: 'calendar' | 'settings';
  asideExpandedToggle: () => void;
  sidebarToggle: () => void;
  setCalendarView: (view: 'calendar' | 'settings') => void;
}
...
export function LayoutProvider({ children, style: customStyle, bodyClassName = '' }: LayoutProviderProps) {
  ...
  const [activeCalendarView, setCalendarView] = useState<'calendar' | 'settings'>('calendar');
