      ...
      >
        ...
        {close && (
          <SheetPrimitive.Close
            ...
            className="cursor-pointer absolute end-5 top-4 rounded-sm opacity-60 transition-opacity hover:opacity-100 focus:outline-hidden focus:ring-0 focus-visible:ring-0 focus-visible:outline-hidden disabled:pointer-events-none"
          >
            <X className="h-4 w-4" />
          </SheetPrimitive.Close>
        )}
