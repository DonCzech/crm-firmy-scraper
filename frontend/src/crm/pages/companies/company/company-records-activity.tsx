                ...
                return (
                  <div key={group.date} className="space-y-5">
                    {group.items.map((item, itemIdx) => {
                      const userName = userNameAt(groupIdx * 10 + itemIdx);
                      const isLastGroup =
                      ...
                      return (
                        <div
                          ...
                          className="relative mb-5 flex min-w-0 gap-3 last:mb-0"
                        >
                            ...
                            <div className="flex min-w-0 flex-1 flex-col">
                              <div className="relative flex min-w-0 flex-wrap items-center gap-2">
                                ...
                                <Link
                                  ...
                                  className="max-w-[180px] truncate text-sm font-medium hover:text-primary"
                                >
                                  {userName}
                                </Link>
                                ...
                                {item.target && item.targetUrl && (
                                  <Link
                                    to={item.targetUrl}
                                    className="max-w-[180px] truncate text-sm text-primary hover:underline"
                                  >
                                    {item.target}
                                  </Link>
                                )}
                                ...
                                {item.org && (
                                  <span className="ml-2 max-w-[180px] truncate rounded bg-muted px-2 py-0.5 text-xs">
                                    {item.org}
                                  </span>
                                )}
                              </div>
                              ...
                              {item.noteContent && (
                                <div className="mt-0.5 ml-8 break-words text-xs text-muted-foreground">
                                  {item.noteContent}
                                </div>
                              )}
                            </div>
                            <div className="mt-0.5 shrink-0 text-xs text-muted-foreground">
                              {item.time}
                            </div>
                          </div>
                        </div>
                            ...
                            <div className="flex flex-col gap-3 grow">
                              <div className="flex flex-wrap items-center justify-between">
                                ...
                                <Button
                                  ...
                                  underlined="dashed"
                                >
                                  <Link to="/core/crm/companies">View</Link>
                                </Button>
                              </div>
